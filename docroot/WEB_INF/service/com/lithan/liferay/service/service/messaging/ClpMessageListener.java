...
package com.lithan.liferay.service.service.messaging;
...
import com.lithan.liferay.service.service.CustomerServiceUtil;
import com.lithan.liferay.service.service.ServicLocalServiceUtil;
import com.lithan.liferay.service.service.ServicServiceUtil;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			ServicLocalServiceUtil.clearService();

			ServicServiceUtil.clearService();
		}
	}
}